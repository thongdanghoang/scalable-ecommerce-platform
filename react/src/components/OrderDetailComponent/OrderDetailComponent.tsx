        ...
        <>
            <div className="OrderDetail" id="OrderDetail">
                <div className="OrderDetail-header">
                    <div
                        className="content"
                        onClick={() => user.role === Role["[ROLE_USER]"] && navigate("/profile-user/order-user")}
                    >
                        <AiOutlineArrowLeft />
                ...
                <div className="OrderDetail-body-content row">
                    <div className="col-md-5 OrderDetail-body-content-address">
                        ...
                        <div className="address">
                            Địa chỉ:{" "}
                            <span>
                                {`${orderDetail?.address.addressDetail} , ${orderDetail?.address.ward
                                    } , ${orderDetail?.address.district?.split("-")[0]} , ${orderDetail?.address.province?.split("-")[0]
                                    }`}
                            </span>
                        </div>
                        <div>
