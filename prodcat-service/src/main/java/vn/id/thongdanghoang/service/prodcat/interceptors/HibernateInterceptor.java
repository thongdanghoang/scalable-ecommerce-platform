package vn.id.thongdanghoang.service.prodcat.interceptors;

import vn.id.thongdanghoang.service.prodcat.entities.AuditableEntity;
import vn.id.thongdanghoang.service.prodcat.entities.AuditableEntity.Fields;
...
public class HibernateInterceptor implements Interceptor {
  ...
  private void updateAuditInfo(
      ...
      String[] propertyNames, String eventType
  ) {
    if (entity instanceof AuditableEntity auditEntity) {
      ...
      if (CREATE_EVENT_LOG_NAME.equals(eventType)) {
        ...
        updateEntityState(state, propertyNames, Fields.createdBy, currentUsername);
      ...
      updateEntityState(state, propertyNames, Fields.lastModifiedBy, currentUsername);
  ...
  private void updateEntityState(
      Object[] state,
      String[] propertyNames, String property,
