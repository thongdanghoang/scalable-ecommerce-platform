            ...
            <Routes>
                {routes.map((route) => {
                    ...
                    return (
                        ...
                        >
                            <>
                                <Route path='/profile-user/information-user' element={<InforUserComponent/>}/>
                                <Route path='/profile-user/address-ship-user' element={<AddressShipComponent/>}/>
                                <Route path='/profile-user/order-user' element={<OrderHistoryComponent/>}>
                                    <Route path='/profile-user/order-user/:code' element={<MyOrderPage/>}/>
                                </Route>
                                <Route path='/profile-user/change-password' element={<ChangePasswordComponent/>}/>
                            </>
